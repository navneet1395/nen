export const metadata = {
  title: "Installation | Nen Docs",
  description: "Install Nen with npx create-nen-app or manually with npm install @nen/client @nen/server. Requires Next.js 13+ App Router and WebAssembly support.",
};
