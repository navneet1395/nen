  ...
  return (
    <div className="not-prose">
      ...
      <div className="rounded-xl border border-border/60 bg-muted/20 p-5 text-sm text-muted-foreground leading-relaxed">
        ...
        <pre className="rounded-lg border border-[var(--code-border)] bg-[var(--code-bg)] p-4 font-mono text-xs text-[var(--code-text)] overflow-x-auto whitespace-pre">{`import { describeNenCode } from '@withnen/server'; // or '@withnen/client'
