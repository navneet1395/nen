export const metadata = {
  ...
  description: "Install Nen with npx create-nen-app or manually with npm install @withnen/client @withnen/server. Requires Next.js 13+ App Router and WebAssembly support.",
};
