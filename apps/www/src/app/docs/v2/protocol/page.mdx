...
export const metadata = {
  title: "Protocol Spec — NEN-PROTOCOL-V2 | Nen Docs",
  description: "The exact wire format: ML-KEM handshake, per-request X-Nen-Nonce header, base64 { ct } payloads, HMAC-SHA256 canonical string, 30s replay window, bidirectional encryption for every HTTP method, SSE stream framing, and session lifecycle. NEN-PROTOCOL-V2.",
};
