...
export const metadata = {
  title: "Isogeny | End-to-End Encrypted APIs, Powered by Post-Quantum Cryptography",
  description:
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <main className="flex-1 flex flex-col items-center">
        {/* ───────────────────────── Hero ───────────────────────── */}
        <section className="w-full py-20 md:py-28 bg-gradient-to-b from-background to-muted/30 flex flex-col items-center text-center px-4 relative overflow-hidden">
          <div className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold border-transparent bg-primary/10 text-primary mb-8 shadow-sm">
            <Zap className="w-3.5 h-3.5 mr-1" /> Post-quantum key exchange (ML-KEM-768, FIPS 203)
          </div>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-10 leading-relaxed">
            HTTPS protects your data in transit — and does it perfectly. But the instant TLS
            terminates, the JSON body lies in plaintext across your logs, databases, CDN, proxies, and
            every third-party hop. <strong className="text-foreground">Isogeny keeps it encrypted the
            whole way.</strong> One line of code. Same TLS you already trust.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mb-8">
            <Link
              ...
              className={buttonVariants({
                variant: "default",
                size: "lg",
                className: "h-12 px-8 font-semibold text-base shadow-lg shadow-primary/20",
              })}
            >
          ...
          <div className="max-w-5xl mx-auto px-6">
            <div className="text-center mb-14">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                TLS encrypts the channel and stops at termination — the load balancer, the CDN edge,
                the serverless runtime. From there your payload travels in the clear. This isn&apos;t a
                flaw in TLS; it&apos;s simply where TLS&apos;s job ends. It&apos;s where Isogeny&apos;s
                begins.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="bg-background border-border/50 shadow-sm">
                ...
                <CardContent className="text-muted-foreground text-sm">
                  Request and response bodies captured in your logging pipeline stay ciphertext —
                  never plaintext PII, PHI, or prompts sitting in a log index.
                </CardContent>
              </Card>
              <Card className="bg-background border-border/50 shadow-sm">
                <CardHeader>
                ...
                <CardContent className="text-muted-foreground text-sm">
                  Payloads you choose not to decrypt come to rest as ciphertext — and because the
                  key exchange is ML-KEM, they stay safe against harvest-now-decrypt-later.
                </CardContent>
              </Card>
              <Card className="bg-background border-border/50 shadow-sm">
                <CardHeader>
                ...
                <CardContent className="text-muted-foreground text-sm">
                  Intermediaries — your CDN, edge, load balancer, internal proxies, and forwarders —
                  see only base64 ciphertext, not the data inside.
                </CardContent>
              </Card>
            </div>
            ...
            <div className="text-center mt-10">
              <Link
                href="/why-not-cloudflare"
                className={buttonVariants({ variant: "outline", className: "font-semibold" })}
              >
        ...
        {/* ─────────────── The fix (relief + ease) ─────────────── */}
        <section className="w-full py-24 relative border-t border-border/40 bg-muted/20">
          <div className="max-w-5xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Swap <code>fetch</code> for <code>pqcfetch</code> on the client. Wrap your route with{" "}
                <code>withIsogeny</code> on the server. The handshake, key rotation, HMAC, and replay
                protection happen underneath. About ten lines, start to finish.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto px-6">
            <div className="text-center mb-10">
              <div className="inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold border-transparent bg-primary/10 text-primary mb-4">
                <Lock className="w-3.5 h-3.5 mr-1" /> Where the trust boundary actually sits
              </div>
              <h2 className="text-3xl font-bold tracking-tight mb-4">No overclaims. Ever.</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                A security engineer will find any exaggeration in thirty seconds — so we draw the line
                ourselves.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-border/60 bg-background p-6 md:p-8 mb-6">
              <p className="text-lg leading-relaxed">
                <strong className="text-foreground">
                  Everything between the two Isogeny endpoints sees only ciphertext.
                </strong>{" "}
                The two endpoints hold plaintext — by necessity, because someone has to read the
                data. The product&apos;s value is letting you{" "}
                <em className="text-foreground">choose where those endpoints are</em>, pushing the
                trust boundary inward past the CDN, edge, load balancer, logs, and proxies — down to
                the specific code that genuinely needs the plaintext.
              </p>
            </div>

            <div className="my-8 flex justify-center">
              <img src="/flows/trust-boundary.svg" alt="Trust Boundary Diagram" className="max-w-full h-auto" />
            </div>

            <p className="text-sm text-muted-foreground mt-6">
              What we will <strong className="text-foreground">never</strong> claim: &ldquo;even a
              compromised server sees only ciphertext.&rdquo; The terminating server decrypts — that
              is the point of the middleware. See the{" "}
        ...
        <section className="w-full py-24 relative border-t border-border/40 bg-muted/20">
          <div className="max-w-5xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Behind <code>pqcfetch</code> is a full post-quantum handshake: an ML-KEM key
                encapsulation, an optional ML-DSA identity signature, and a derived ChaCha20-Poly1305
                session. Run it step by step — change the payload, change the security level, and
          ...
          <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-4 leading-relaxed">
                AI apps stream prompts, PHI, legal context, and financial records through many hops
                of your own infrastructure. Isogeny keeps prompts and streamed tokens as ciphertext
                from the user&apos;s browser to the one backend service you trust to call the model.
              </p>
              <p className="text-sm text-muted-foreground mb-6">
                Honest scope: this hides prompts from <em>your</em> edge, logs, and proxies. It does{" "}
                <strong className="text-foreground">not</strong> hide them from the model provider —
                they must decrypt to run inference.
              </p>
              <Link
                href="/ai"
                className={buttonVariants({ variant: "outline", className: "font-semibold" })}
...
// CDN, logs, and proxies see only ciphertext.`}</pre>
        ...
        <section className="w-full py-24 relative border-t border-border/40">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold tracking-tight mb-4">Who reaches for this</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Security and platform engineers at fintech, healthtech, and AI companies who just got
                a PQC-readiness or data-handling audit questionnaire — and need documentation and
                proof as much as code.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="bg-background border-border/50 shadow-sm">
                ...
                <CardContent className="text-muted-foreground">
                  Keep transaction payloads as ciphertext past TLS termination — through logs,
                  proxies, and at-rest stores — so harvested ciphertext stays safe against future
                  quantum decryption.
                </CardContent>
              </Card>
              ...
              <Card className="bg-background border-border/50 shadow-sm">
                ...
                <CardContent className="text-muted-foreground">
                  ePHI stays encrypted from the device to the one service that must read it, shrinking
                  the plaintext-exposed surface your auditor asks about.
                </CardContent>
              </Card>
              ...
              <Card className="bg-background border-border/50 shadow-sm">
                ...
                <CardContent className="text-muted-foreground">
                  Encrypt prompts and streamed responses across your own infrastructure with secure
                  SSE streaming — a niche most PQC projects never reach.
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        {/* ─────────────── Closing CTA ─────────────── */}
        <section className="w-full py-24 border-t border-border/40 bg-gradient-to-b from-muted/20 to-background">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">
              Keep TLS. Add the part it can&apos;t reach.
            </h2>
            <p className="text-muted-foreground max-w-xl mx-auto mb-8">
              The free SDK gives you the protection. The docs give you the proof your auditor wants.
              Both ship today.
            </p>
