...
export function ArchitectureVisualizer() {
  return (
    <div className="w-full max-w-5xl mx-auto py-8">
      ...
      <div className="relative w-full aspect-[21/9] min-h-[300px] flex items-center justify-center bg-background/50 backdrop-blur-md border border-border shadow-2xl rounded-3xl overflow-hidden group">
        ...
        <svg className="absolute inset-0 w-full h-full z-10" viewBox="0 0 1000 400" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="gradient-tunnel" x1="0%" y1="0%" x2="100%" y2="0%">
              ...
              <stop offset="50%" stopColor="#7ec8e3" stopOpacity="0.6" />
              <stop offset="100%" stopColor="#b2d5e5" stopOpacity="0.2" />
            </linearGradient>
            
            <linearGradient id="path-gradient" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#b2d5e5" stopOpacity="0" />
              <stop offset="50%" stopColor="#7ec8e3" stopOpacity="1" />
        ...
        <div className="absolute left-[10%] md:left-[15%] z-20 flex flex-col items-center animate-float" style={{ animationDelay: '0s' }}>
          <div className="w-16 h-16 rounded-2xl bg-background border border-border shadow-xl shadow-primary/20 flex items-center justify-center relative group-hover:scale-105 transition-transform">
