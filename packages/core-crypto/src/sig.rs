...
pub struct NenSigningKeypair {
    pub public_key: Vec<u8>,
    pub secret_key: Vec<u8>,
}

#[wasm_bindgen]
pub fn nen_generate_signing_keypair() -> Result<NenSigningKeypair, JsValue> {
...
#[wasm_bindgen]
pub fn nen_sign(secret_key: &[u8], message: &[u8]) -> Result<Vec<u8>, JsValue> {
...
#[wasm_bindgen]
pub fn nen_verify_signature(public_key: &[u8], message: &[u8], signature_bytes: &[u8]) -> bool {
