...
export const nen_derive_enc_key: (a: number, b: number, c: number) => void;
export const nen_derive_mac_key: (a: number, b: number, c: number) => void;
...
export const nen_hkdf: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
...
export const nen_hybrid_combine: (a: number, b: number, c: number, d: number, e: number) => void;
export const nen_ratchet_key: (a: number, b: number, c: number) => void;
...
export const nen_transcript_hash: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
export const nen_verify_signature: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
export const nen_x25519_dh: (a: number, b: number, c: number, d: number, e: number) => void;
export const nen_x25519_keypair: () => number;
...
export const __wbg_get_nenx25519keypair_secret_key: (a: number, b: number) => void;
export const __wbg_set_nenx25519keypair_secret_key: (a: number, b: number, c: number) => void;
export const __wbg_set_nenx25519keypair_public_key: (a: number, b: number, c: number) => void;
export const __wbg_get_nenx25519keypair_public_key: (a: number, b: number) => void;
export const __wbg_nenx25519keypair_free: (a: number, b: number) => void;
